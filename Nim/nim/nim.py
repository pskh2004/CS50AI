...
class NimAI():
    ...
    def best_future_reward(self, state):
        ...
        for actions in action:
            action_value = self.q.get((tuple(state), actions))
            if action_value is None:
                action_value = 0
            if best_action is None or action_value > best_action:
    ...
    def choose_action(self, state, epsilon=True):
        ...
        for actions in action:
            ...
            if action_value is None:
                action_value = 0
            if best_action2 is None or action_value > best_action2:
                best_action2 = action_value
                best_action = actions
        return best_action
